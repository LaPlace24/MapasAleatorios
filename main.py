...
class JuegoArchivo(Juego):
    def __init__(self, path_a_mapas):
        ...
        super().__init__(*self.obtener_mapa_aleatorio())

    def obtener_mapa_aleatorio(self):
        archivo = random.choice(os.listdir(self.path_a_mapas))
        archivo_completo = os.path.join(self.path_a_mapas, archivo)
        return self.leer_mapa_archivo(archivo_completo)
